...
public class Fragment_Main_Screen_Light extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
    ...
    LinearLayout linearLayout_Tempreture_light =
        v.findViewById(R.id.linear_layout_light_Tempreture_history_id);
    linearLayout_Tempreture_light.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
    ...
    LinearLayout linearLayout_Humadity_light =
        v.findViewById(R.id.linear_layout_light_Humadity_history_id);
    linearLayout_Humadity_light.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
    ...
    LinearLayout linearLayout_Speed_light =
        v.findViewById(R.id.linear_layout_light_Speed_history_id);
    linearLayout_Speed_light.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
    ...
    LinearLayout linearLayout_Carried_Weight_light =
        v.findViewById(R.id.linear_layout_light_Carried_Weight_history_id);
    linearLayout_Carried_Weight_light.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
