...
public class Fragment_Speed_History_Light extends Fragment {
    MainActivity myActivity;

    public Fragment_Speed_History_Light(MainActivity m) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        v = inflater.inflate(R.layout.max_speed_history_light, container, false);
        ImageView imageView = v.findViewById(R.id.GoBack_to_main_screen_from_light_max_speed_history_screen_id);
