...
public class Fragment_Carried_Weight_History extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
    ...
    TV_deviceName =
        v.findViewById(R.id.TextView_Device_Name_in_Carried_Weight_History_Screen_Black);
    ...
    TextView max_carried_weight =
        v.findViewById(R.id.max_carried_weight_button_in_carried_weight_screen);
    TextView avg_carried_weight =
        v.findViewById(R.id.avg_carried_weight_button_in_carried_weight_screen);

    ImageView imageView =
        v.findViewById(R.id.GoBack_to_main_screen_from_black_carried_weight_screen_id);
    ...
    buttons[0].setOnClickListener(
        new View.OnClickListener() { // daily
          @Override
          public void onClick(View v) {
    ...
    buttons[1].setOnClickListener(
        new View.OnClickListener() { // weakly
          @Override
          public void onClick(View v) {
    ...
    buttons[2].setOnClickListener(
        new View.OnClickListener() { // monthly
          @Override
          public void onClick(View v) {
    ...
    buttons[3].setOnClickListener(
        new View.OnClickListener() { // yearly
          @Override
          public void onClick(View v) {
    ...
    max_carried_weight.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            max_carried_weight.setBackgroundResource(
                R.drawable.purple_background_for_buttons_in_blacked_history_screens);
            avg_carried_weight.setBackgroundResource(
                R.drawable.gray_background_for_buttons_in_blacked_history_screens);
          }
        });

    avg_carried_weight.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            max_carried_weight.setBackgroundResource(
