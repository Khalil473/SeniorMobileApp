...
public class Fragment_Main_Screen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState)
    {
        ...
        linearLayout_Tempreture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        linearLayout_Humadity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        linearLayout_Speed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
