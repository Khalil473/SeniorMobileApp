...
public class Fragment_Carried_Weight_History_Light extends Fragment {

    MainActivity myActivity;
    public Fragment_Carried_Weight_History_Light(MainActivity m){
    ...
    {
        v= inflater.inflate(R.layout.carried_wieght_history_light,container,false);
        ImageView imageView = v.findViewById(R.id.GoBack_to_main_screen_from_light_carried_weight_screen_id);
